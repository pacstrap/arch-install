...
#  Default: ''
# c.ServerApp.browser = ''
c.ServerApp.browser = 'google-chrome-stable --app=%s --start-maximized'
...
#  Choices: any of ['sha512', 'sha3_224', 'sha256', 'sha1', 'sha3_256', 'sha3_384', 'sha3_512', 'sha384', 'blake2s', 'md5', 'sha224', 'blake2b']
#  Default: 'sha256'
