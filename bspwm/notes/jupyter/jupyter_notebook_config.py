...
c.NotebookApp.browser = 'google-chrome-stable --app=%s --start-maximized'
...
#  Choices: any of ['sha224', 'sha3_224', 'sha3_384', 'sha3_256', 'sha256', 'blake2b', 'sha512', 'md5', 'blake2s', 'sha3_512', 'sha384', 'sha1']
#  Default: 'sha256'
