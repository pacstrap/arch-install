...
printf "\e[1;32m$ pacstrap -i /mnt base base-devel linux linux-firmware linux-headers amd-ucode nano git reflector rsync lvm2 networkmanager\e[0m\n"; confirm;
pacstrap -i /mnt base base-devel linux linux-firmware linux-headers amd-ucode nano git reflector rsync lvm2 networkmanager
