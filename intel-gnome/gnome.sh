...
printf "\e[1;32m$ ln -sf /usr/share/zoneinfo/Europe/London /etc/localtime\e[0m\n"; confirm;
...
printf "\e[1;32m$ pacman -S xorg xorg-xinit xdg-{user-dirs,utils} xf86-input-libinput xf86-video-{fbdev,vesa,intel}\e[0m\n"; confirm;
pacman -S xorg xorg-xinit xdg-{user-dirs,utils} xf86-input-libinput xf86-video-{fbdev,vesa,intel}
...
printf "\e[1;32m$ nano /etc/X11/xorg.conf.d/20-intel.conf\e[0m\n"; confirm;
